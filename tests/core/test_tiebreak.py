...
class TestTiebreakInit:
    ...
    def test_init_default_score(self):
        tb = Tiebreak(playerToServe=1, isSuper=False, matchFormat=DEFAULT_FORMAT)
    ...
    def test_init_player2_serves(self):
        tb = Tiebreak(playerToServe=2, isSuper=False, matchFormat=DEFAULT_FORMAT)
        assert tb.servesNext == 2

    def test_init_super_tiebreak(self):
        tb = Tiebreak(playerToServe=1, isSuper=True, matchFormat=DEFAULT_FORMAT)
    ...
    def test_init_with_custom_score(self):
        ...
        tb = Tiebreak(playerToServe=1, isSuper=False, initScore=init_score)
    ...
    def test_init_invalid_server(self):
        with pytest.raises(ValueError):
            Tiebreak(playerToServe=0, isSuper=False, matchFormat=DEFAULT_FORMAT)
        with pytest.raises(ValueError):
            Tiebreak(playerToServe=3, isSuper=False, matchFormat=DEFAULT_FORMAT)

    def test_init_invalid_score_type(self):
        with pytest.raises(ValueError):
            Tiebreak(playerToServe=1, isSuper=False, initScore="invalid", matchFormat=DEFAULT_FORMAT)

    def test_init_invalid_isSuper_type(self):
        with pytest.raises(ValueError):
            Tiebreak(playerToServe=1, isSuper="yes", matchFormat=DEFAULT_FORMAT)
    ...
    def test_init_missing_matchFormat(self):
        with pytest.raises(ValueError):
            Tiebreak(playerToServe=1, isSuper=False)
...
class TestTiebreakWithInitialScore:
    ...
    def test_start_at_match_point(self):
        ...
        tb = Tiebreak(playerToServe=2, isSuper=False, initScore=init_score)
    ...
    def test_start_near_end_super(self):
        ...
        tb = Tiebreak(playerToServe=1, isSuper=True, initScore=init_score)
